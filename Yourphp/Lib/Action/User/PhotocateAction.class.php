...
class PhotocateAction extends BaseAction
{
    function _initialize()
    {
        parent::_initialize();
        $this->dao = M('Photocate');
    }

    public function index()
    {

        $this->assign("url",U('Photocate/index'));
    ...
    public function save()
    {
        ...
        if(false !== $result) {
            $this->assign("jumpUrl",U("Photocate/index"));
    ...
    public function master()
    {
        ...
        $data['is_home'] = 1;
        $mod->where($where)->data($data)->save();
        $this->assign('jumpUrl',U('Photocate/show',array('id'=>$cateid)));
        $this->success("操作成功");
    }
